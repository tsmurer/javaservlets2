...
<html><head>
    ...
    <div class="section">
      <div class="container">
        <div class="row">
          <div class="col-md-12 text-center">
            <h3 class="tt_menu">&gt;&gt; Consultar Pagamento &lt;&lt;</h3>
          </div>
        </div>
        <div class="row">
          <div class="col-md-12">
            <form class="form-horizontal" role="form" id="form" name="form" method="post" action="../Controlador">
              ...
              <div class="form-group">
                <div class="col-sm-offset-2 col-sm-10">
                	<input type="hidden" name="formulario" value="pagamento consulta">
                	<input type="hidden" name="validadorCPF" value="">
                  <button type="button" class="btn btn-danger" onclick="validacaoCPF(document.form.cpf.value, document.form, document.form.validadorCPF)">Excluir</button>
                </div>
              </div>
            </form>
          </div>
