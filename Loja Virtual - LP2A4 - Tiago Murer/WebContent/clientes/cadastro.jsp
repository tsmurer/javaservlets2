  ...
  <%@ include file="../topo.jsp" %>
    ...
    <div class="section">
      <div class="container">
        <div class="row">
          <div class="col-md-12 text-center">
            <h3 class="tt_menu">&gt;&gt; Consultar Novo Cliente &lt;&lt;</h3>
          </div>
        </div>
        <div class="row">
          <div class="col-md-12">
            <form class="form-horizontal" role="form" id="form" name="form" method="post" action="../Controlador">
              ...
              <div class="form-group">
                <div class="col-sm-offset-2 col-sm-10">
                	<input type="hidden" name="formulario" value="cliente cadastro">
                	<input type="hidden" name="validadorCPF" value="">
                	<input type="hidden" name="validadorEmail" value="">
                  <button type="button" class="btn btn-danger" onclick="validadores(document.form.cpf.value, document.form.email.value, document.form, document.form.validadorCPF, document.form.validadorEmail)">Cadastrar</button>
                </div>
              </div>
            </form>
          </div>
